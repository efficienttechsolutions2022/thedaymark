...
const FooterHome = ({ className = "" }) => {
  return (
    <footer className={className}>
      <div className="bg-clay text-white h-full">
        <Container
            ...
            <div className="flex xl:flex-row xl:justify-between">
              <div className="flex flex-1 flex-col xl:flex-row items-center justify-center xl:pr-10">
                ...
                <div className="flex flex-1 flex-col gap-1 xl:gap-0.5 xl:ml-32 text-[7px] text-center xl:text-left xl:pr-16 2xl:pr-40">
                  <p>
                    This advertisement is not an offering. It is a solicitation
                    of interest in the advertised property. No offering of the
                    advertised units can be made, and no deposits can be
                    accepted, or reservations, binding, or non-binding, can be
                    made until an offering plan is filed with the New York State
                    Department of Law. This advertisement is made pursuant to
                    Cooperative Policy Statement No. 1, issued by the New York
                    State Department of Law. File No. CP22-0040. The Daymark
                    Condominium. Sponsor: LL Parcel H, LLC, 135 E. 57th Street,
                    14th Floor, NY, NY 10022.
                  </p>
                  <p>
                    Identification is required of all consumers in regard to
                    purchasing and leasing a property. Exclusive Broker
                    Agreements are not required of consumers purchasing or
                    leasing a property. Pre-Approval of Purchase Loans and
                    Pre-Approval or Pre-Qualification of Leasing is not required
                    prior to visiting a property. All images are a combination
                    of photography and artist renderings and are provided for
                    illustrative purposes only. PRIVACY POLICY | NYS FAIR
                    HOUSING
                  </p>
                </div>
